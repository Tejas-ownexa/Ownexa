  ...
  return (
    <div className="p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      <div className="flex justify-between items-center mb-6">
        ...
        <button onClick={handleCancel} className="text-gray-500 dark:text-gray-300 dark:text-gray-400 dark:text-gray-300 dark:text-gray-500 dark:text-gray-300 hover:text-gray-700 dark:text-gray-300">
          <X className="h-6 w-6" />
        </button>
      </div>
      ...
      <form className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                type="text"
                className="border border-gray-300 dark:border-gray-600 rounded-md px-3 py-2 w-full mb-2"
        ...
        <div className="flex gap-4">
          ...
          <button
            ...
            className="text-gray-600 dark:text-gray-300 hover:text-gray-800 dark:text-gray-200"
          >
            Cancel
          </button>
        </div>
