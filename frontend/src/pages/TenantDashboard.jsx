      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">Your Property</h2>
          </div>
          <div className="p-6">
            {tenantData?.property ? (
        ...
        <div className="bg-white shadow rounded-lg">
          <div className="px-6 py-4 border-b border-gray-200">
            <h2 className="text-lg font-medium text-gray-900">Lease Information</h2>
          </div>
          <div className="p-6">
            {tenantData ? (
              <div className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <h4 className="font-medium text-gray-700">Lease Start</h4>
                    <p className="text-gray-600">
                      {tenantData.lease_start ? new Date(tenantData.lease_start).toLocaleDateString() : 'Unknown'}
                    </p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-700">Lease End</h4>
                    <p className="text-gray-600">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-600">${tenantData.rent_amount || 0}</p>
                  </div>
                  <div>
                    <h4 className="font-medium text-gray-700">Payment Status</h4>
                    <p className={`font-medium ${
                      tenantData.payment_status === 'active' ? 'text-green-600' : 'text-red-600'
                    }`}>
                ...
                {maintenanceRequests.slice(0, 5).map((request) => (
                  <div key={request.id} className="border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <h4 className="font-medium text-gray-900">Request #{request.id}</h4>
                        <p className="text-gray-600 text-sm mt-1">{request.request_description}</p>
