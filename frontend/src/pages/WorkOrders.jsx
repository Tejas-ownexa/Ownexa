  ...
  return (
    <div className="relative multi-select-dropdown">
      <button
        ...
        className="appearance-none bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 pr-8 text-sm text-gray-700 dark:text-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent w-full text-left"
      >
        {getDisplayText()}
      </button>
      ...
      {isOpen && (
        <div className="absolute z-10 mt-1 w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg">
          <div className="p-2">
            {options.map((option) => (
              <label key={option.value} className="flex items-center space-x-3 p-2 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900 rounded cursor-pointer">
...
const WorkOrders = () => {
  ...
  const getStatusBadge = (status) => {
    const statusStyles = {
      ...
      'on_hold': 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200'
    };
    
    return (
      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${statusStyles[status] || 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200'}`}>
  ...
  const getPriorityBadge = (priority) => {
    const priorityStyles = {
      ...
      'medium': 'bg-yellow-100 text-yellow-800 dark:text-yellow-200',
      'low': 'bg-green-100 dark:bg-green-900/30 text-green-800 dark:text-green-200'
    };
    
    return (
      <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${priorityStyles[priority] || 'bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-200'}`}>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-4 sm:space-y-0">
          <div className="flex items-center space-x-2">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 dark:text-white">Work orders</h1>
          ...
          <div className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
            ...
            <button 
              ...
              className="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 px-4 py-2 rounded-lg hover:bg-gray-200 transition-colors text-sm font-medium"
            >
              Print work orders
            </button>
          </div>
          ...
          <table className="min-w-full">
            <thead>
              <tr className="border-b border-gray-200 dark:border-gray-600">
                ...
                <th 
                  className="text-left py-3 px-4 text-xs font-medium text-gray-500 dark:text-gray-300 dark:text-gray-400 dark:text-gray-500 dark:text-gray-300 uppercase tracking-wider cursor-pointer hover:text-gray-700 dark:text-gray-300"
            ...
            <tbody>
              {workOrdersLoading ? (
                <tr>
                  <td colSpan="11" className="text-center py-12 text-gray-500 dark:text-gray-300 dark:text-gray-400 dark:text-gray-500 dark:text-gray-300">
                ...
                filteredAndSortedWorkOrders.map((workOrder) => (
                  <tr key={workOrder.id} className="border-b border-gray-200 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-700 dark:bg-gray-900">
                    <td className="py-3 px-4">
                      <div className="flex items-center space-x-3">
                        <div>
                          ...
                          <div className="text-sm text-gray-500 dark:text-gray-300 dark:text-gray-400 dark:text-gray-500 dark:text-gray-300 truncate max-w-xs">
                            {workOrder.title}
                          </div>
                        </div>
                        <div className="flex space-x-1">
                          ...
                          <button 
                            ...
                            className="p-1 text-gray-400 dark:text-gray-500 dark:text-gray-300 hover:text-gray-600 dark:hover:text-gray-400 dark:text-gray-300 transition-colors" 
                            title="More options"
                          >
