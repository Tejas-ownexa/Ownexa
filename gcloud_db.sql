...
-- 2. RENTAL OWNERS TABLE (moved before properties to fix dependency)
...
-- 22. RENTAL OWNERS TABLE (already created above, skipped to avoid duplicate)
...
-- Removed invalid index: listing_status_id column does not exist in leasing_applicants table
...
-- Additional indexes for new tables (removed duplicates - already created above)
